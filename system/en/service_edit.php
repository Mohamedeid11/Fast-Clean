    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">Project Service  </h4>
                        <ol class="breadcrumb">
                            <li><a href="service_view.php">Project Service  </a></li>
                            <li class="active"> Update Project Service  </li>
                        </ol>
                    </div>
                </div>
                ...
                if ($_GET['projectID']) {
                    ...
                    $query_select = $con->query("SELECT * FROM `project_service` WHERE `id` = '{$get_project_id}' LIMIT 1");
