                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><?=lang('washer_contact')?></li>
                        </ol>
                    </div>
                </div>
                <div class="container">
                        ...
                        <div class="panel-body">
                            <div class="">
                                <table class="table table-striped" id="datatable-editable">
                                    ...
                                    $query = $con->query("SELECT * FROM `washer_contact` ORDER BY `id` ASC");
                                    $x = 1;
                                    while ($row = mysqli_fetch_assoc($query)) {
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td><?= $date; ?></td>
                                            <td class="actions">
                                                <a href="washer_contact_edit.php?washerID=<?= $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
                                            </td>
                                            <td class="actions">
    ...
    $(document).ready(function () {
        $('body').on('click', '.on-default', function () {
            ...
            $("#dialogConfirm").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "functions/washer_contact_function.php",
                    data: dataString,
                    dataType: 'text',
                    cache: false,
