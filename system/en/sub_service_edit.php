                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <ol class="breadcrumb">
                                    <li><a href="sub_service_view.php">Projects </a></li>
                                        ...
                                        <div class="card-box">
                                            <form method="POST" enctype="multipart/form-data" data-parsley-validate novalidate>
                                                ...
                                                <div class="form-group col-md-5">
                                                    <label for="sub_cat_name">Project Name English</label>
                                                ...
                                                <div class="form-group col-md-5">
                                                    <label for="sub_cat_name_ar"> Project Name Arabic</label>
                                                ...
                                                <div class="form-group  col-md-5">
                                                    <label for="parent_category_id_update">Choose Client  </label>
                                                    <select class="form-control select2me" name="parent_category_id_update" id="parent_category_id" required parsley-trigger="change">
                                                        ...
                                                        while ($row = mysqli_fetch_assoc($query)) {
                                                            ...
                                                            if ($get_parent_category_id == $client_id) {
                                                                echo "<option value='{$client_id}' selected='selected'>{$client_name_en}-{$client_name_ar}</option>";
                                                            } else {
