            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ol class="breadcrumb">
                            <li><a href="sub_service_view.php">View Projects</a></li>
                ...
                <div class="panel">
                    <div class="panel-body">
                        <div class="">
                            <div class="col-md-3">
                                <label  for="sub_ct_name" class=" control-label">Search By English Project Name     </label>
                            ...
                            <table class="table table-striped" id="">
                                ...
                                foreach ($allData as $key => $row) {
                                    ...
                                    $client_id = $row['parent_category_id'];
                                    $date = $row['date'];
                                    $display = $row['display'];
                                    ...
                                    <tr class="gradeX <?php echo $sub_category_id; ?>">
                                        ...
                                        <td><?php echo sub_parent_category($client_id); ?></td>
                                        <td>
