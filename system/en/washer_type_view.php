...
<div id="wrapper">
    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                <?php
                $query = $con->query( " SELECT * FROM `washer_type` where 1=1  ");
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ol class="breadcrumb">
                            <li><a href="washer_type_view.php"><?= lang('washer_type')?> </a></li>
                            <li class="active"><?= lang('washer_type')?>   </li>
                        </ol>
                    </div>
                </div>
                <h4>
                        ...
                        <table class="table table-striped" id="datatable-editable">
                            ...
                            while ($row = mysqli_fetch_assoc($query)) {
                                ...
                                <tr class="gradeX<?= $washer_id ?>">
                                    ...
                                    <td><?= $date; ?></td>
                                    <td class="actions">
                                        <a href="washer_type_edit.php?washer_typeID=<?= $washer_id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
                                    </td>
                                    <td class="actions">
    ...
    $(document).ready(function () {
        $('body').on('click', '.on-default', function () {
            ...
            $("#dialogConfirm").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "functions/washer_type_function.php",
                    data: dataString,
                    dataType: 'text',
                    cache: false,
