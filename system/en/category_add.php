...
<div id="wrapper">
    ...
    if (isset($_POST['submit'])) {
        $category_name_en = mysqli_real_escape_string($con, trim($_POST['name_en']));
        $category_name_ar = mysqli_real_escape_string($con, trim($_POST['name_ar']));
        ...
        if (!empty($errors)) {
            ...
            $con->query("INSERT INTO `category` (`category_name_en`, `category_name_ar`, `display`) VALUES ('$category_name_en', '$category_name_ar','$display')");
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><?= lang('add_new_category')?>  </li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
