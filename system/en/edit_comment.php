...
if (isset($_POST['comment_update'])) {
    ...
    $update = $con->query("UPDATE `comments` SET `comment`='" . $temp['comment'] . "',`rate`='" . $temp['rate'] . "' WHERE `comment_id`='" . $temp['id'] . "'");
                ...
                <div class="content">
                    <div class="container">
                        ...
                        if ($_GET['comment_id']) {
                            ...
                            $query_select = $con->query("SELECT * FROM `comments` WHERE `comment_id` = '{$comment_id}' LIMIT 1");
