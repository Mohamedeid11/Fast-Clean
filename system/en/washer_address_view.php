                        ...
                        <div class="">
                            <table class="table table-striped" id="datatable-editable">
                                ...
                                <tr>
                                    ...
                                    <th><?=lang('address_en')?></th>
                                    <th><?=lang('address_ar')?></th>
                                    <th><?=lang('address_map')?></th>
                                    <th><?=lang('date_add')?></th>
                                    <th><?=lang('action')?></th>
                                ...
                                $query = $con->query("SELECT * FROM `washer_address` ORDER BY `id` ASC");
                                $x = 1;
                                while ($row = mysqli_fetch_assoc($query)) {
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td><?= $date; ?></td>
                                        <td class="actions">
                                            <a href="washer_address_edit.php?washerID=<?= $id; ?>" class="on-default"><i class="fa fa-pencil"></i></a>
                                        </td>
                                        <td class="actions">
    ...
    $(document).ready(function () {
        $('body').on('click', '.on-default', function () {
            ...
            $("#dialogConfirm").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "functions/washer_address_function.php",
                    data: dataString,
                    dataType: 'text',
                    cache: false,
