...
<div id="wrapper">
    ...
    if (isset($_POST['submit'])) {
        $vehicle_name_en = mysqli_real_escape_string($con, trim($_POST['name_en']));
        $vehicle_name_ar = mysqli_real_escape_string($con, trim($_POST['name_ar']));
        $display = $_POST['display'];



        $errors = array();
        if (empty($vehicle_name_en)) {
            $errors[] = "Please enter Washer Type Name In English!";
        }
        if (empty($vehicle_name_ar)) {
        ...
        if (!empty($errors)) {
            ...
            $con->query("INSERT INTO `vehicle_type` (`vehicle_name_en`, `vehicle_name_ar`, `display`) VALUES ('$vehicle_name_en', '$vehicle_name_ar','$display')");
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><?= lang('add_new_vehicle')?>  </li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
