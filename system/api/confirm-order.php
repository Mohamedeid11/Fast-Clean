        ...
        if ($client_address_id != '') {
            ...
            if ($check_branch_avaliable_delivery == 1) {
                ...
                if ($check_discount == 1) {
                    ...
                    $total_amount_after_disc = $total_amount - (($discount_percentage / 100) * $total_amount);
                } else {
                ...
                if ($get_order_price >= $min_order) {
                    ...
                    $result = mysql_query("INSERT INTO orders(cart_id,client_id,client_address_id,branch_id,total_price,charge_cost,discount_percentage,vat,net_price,order_status,order_follow,payment,deliver_id,mobile_type,date) 
	VALUES('$cart_id','$client_id','$client_address_id','$branch_id','$total_amount','$get_charge','$discount_percentage','$vat_added','$net_price_after_vat','0','0','$payment','$deliver_id','$mobile_type','" . date("Y-m-d H:i:s") . "')");
                    ...
                    if ($result) {
                        ...
                        $subject = "Berry - بيري  - طلب جديد";
                        $headers = 'MIME-Version: 1.0' . "\r\n";
                        $headers .= 'Content-type: text/html; charset=utf-8' . "\r\n";
                        $headers .="From:  Berry App" . " Info@emcan-group.com\r\n" . "Reply-To:Info@emcan-group.com\r\n";
...
" . $min_order . " BD";
            ...
            $result = mysql_query("INSERT INTO orders(cart_id,client_id,client_address_id,branch_id,total_price,charge_cost,discount_percentage,vat,net_price,order_status,order_follow,payment,deliver_id,mobile_type,date) 
	VALUES('$cart_id','$client_id','','$branch_id','$total_amount','$get_charge','$discount_percentage','$vat_added','$net_price_after_vat','0','0','$payment','$deliver_id','$mobile_type','" . date("Y-m-d H:i:s") . "')");
