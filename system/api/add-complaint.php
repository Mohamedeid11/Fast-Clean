...
if (isset($_POST) && !empty($_POST)) {
    ...
    $subject = ':قسم الشكاوي والإقتراحات' . " تطبيق مطعم بيري 74";
    $headers = 'MIME-Version: 1.0' . "\r\n";
    $headers .= 'Content-type: text/html; charset=utf-8' . "\r\n";
    $headers .="From:apps@emcan-group.com\r\n" . "Reply-To:Info@emcan-group.com\r\n";

    $message = " إسم العميل : <br />" . $client_name . "<br /> <br />";
    $message .= " رقم الهاتف : <br />" . $client_phone . "<br /> <br />";
    $message .= " العنوان : <br />" . $title . "<br /> <br />";
    $message .= " المحتوى : <br />" . $content;
...
// Path to move uploaded files
    ...
    $file_upload_url = 'http://berry74.com/system/api/';
    $itr = $_POST['itr'];
    for ($i = 1; $i <= $itr; $i++) {
        // Path to move uploaded files
